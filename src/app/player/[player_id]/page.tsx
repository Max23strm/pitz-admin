import CalendarCard from "@/components/custom/playerPage/CalendarCard"
        ...
        <main className='flex flex-col gap-4 min-h-screen p-5'>
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 w-12/12 md:w-12/12">
                ...
                <Card className="w-full flex flex-col gap-4 md:min-w-[300px] md:w-full h-fit my-auto">
                    ...
                    <Separator />
                    <CardHeader>
                        <CardTitle className="text-primary text-1xl font-bold mb-2">
                            Contacto
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <Card className="w-full col:w-6/12">
                    <CardHeader>
                        <CardTitle className="text-primary text-1xl font-bold">Información</CardTitle>
                    </CardHeader>
